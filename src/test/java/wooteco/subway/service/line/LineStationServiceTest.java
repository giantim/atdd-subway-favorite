...
public class LineStationServiceTest {
    ...
    private static final String STATION_NAME5 = "교대역";
    private static final String STATION_NAME6 = "고속터미널역";
    ...
    void wholeLines() {
        ...
        newLine.addLineStation(new LineStation(station4, station5, 10, 10));
        newLine.addLineStation(new LineStation(station5, station6, 10, 10));
