...
export const edgeItemTemplate = edge => {
    return `<li data-edge-departure="${edge.departureName}"
                data-edge-arrival="${edge.arrivalName}" 
